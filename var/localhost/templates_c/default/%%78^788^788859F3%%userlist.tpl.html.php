<?php /* Smarty version 2.6.7, created on 2017-08-24 10:52:47
         compiled from setting/userlist.tpl.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'setting/userlist.tpl.html', 22, false),array('modifier', 'default', 'setting/userlist.tpl.html', 72, false),array('function', 'cycle', 'setting/userlist.tpl.html', 70, false),)), $this); ?>
    ...
    <div class="cont_bg_mdl">
   	<div class="content">
            ...
            <div class="cont_hdr1 fltlft" style="padding-left:10px;">
                ...
                <div class="fltlft">
                            User list  (<?php echo $this->_tpl_vars['sm']['next_prev']->total; ?>
)
                        </div>

                <div class="fltrht"><?php if ($_SESSION['id_company']): ?><input type="button" name="addusers" value="Add" onclick="addusers();" class="login_btn"/><?php endif; ?></div>
...
">
                            <td> <?php echo $this->_tpl_vars['x']['email_id']; ?>
</a></td>
                            <td><?php echo ((is_array($_tmp=@$this->_tpl_vars['x']['displayname'])) ? $this->_run_mod_handler('default', true, $_tmp, 'NA') : smarty_modifier_default($_tmp, 'NA')); ?>
</td>
                            <td><?php echo ((is_array($_tmp=@$this->_tpl_vars['x']['isactive'])) ? $this->_run_mod_handler('default', true, $_tmp, 'NA') : smarty_modifier_default($_tmp, 'NA')); ?>
</td>
                            <td><?php echo $this->_tpl_vars['x']['add_date']; ?>
</td>
                            <?php if ($_SESSION['id_company']): ?>
                            <td>
                            <a href="javascript:void(0);" onclick="editusers('edit','<?php echo $this->_tpl_vars['x']['id_userdetails']; ?>
')">
                                    <img src="http://localhost/simplehrm/templates/images/blue/edit_img.png" alt="" title="Edit"/></a>
                                <img src="http://localhost/simplehrm/templates/images/blue/delete_img.png" alt="delete" title="Delete" onclick="return del('<?php echo $this->_tpl_vars['x']['id_userdetails']; ?>
