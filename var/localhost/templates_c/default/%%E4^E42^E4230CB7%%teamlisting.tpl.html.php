<?php /* Smarty version 2.6.7, created on 2017-08-24 10:53:08
         compiled from setting/teamlisting.tpl.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'setting/teamlisting.tpl.html', 22, false),array('modifier', 'capitalize', 'setting/teamlisting.tpl.html', 66, false),array('modifier', 'wordwrap', 'setting/teamlisting.tpl.html', 70, false),array('function', 'cycle', 'setting/teamlisting.tpl.html', 65, false),)), $this); ?>
    ...
    <div class="cont_bg_mdl">
    	<div class="cont_hdr1 fltlft">
            ...
            <div class="cont_hdr_mdl1 fltlft">
                <div class="fltlft">
                	 Teams list (<?php echo $this->_tpl_vars['sm']['next_prev']->total; ?>
)                  
                </div>
                <div class="fltrht">
                	<input type="button" name="addEditTeam" value="Add" onclick="addEditTeam('add','')"/>
                </div>
                <div class="clear"></div>
...
">
                                ...
                                <td align="center"><?php if ($this->_tpl_vars['sm']['res1'][$this->_tpl_vars['x']['id_team']]):  echo $this->_tpl_vars['sm']['res1'][$this->_tpl_vars['x']['id_team']];  else: ?>0<?php endif; ?></td>
                                ...
                                <td>
                                     <a href="javascript:void(0);" onclick="addEditTeam('edit','<?php echo $this->_tpl_vars['x']['id_team']; ?>
')"><img src="http://localhost/simplehrm/templates/images/blue/edit_img.png" alt="" title="Edit"/></a>			
                                     &nbsp;&nbsp;&nbsp;
                                    <?php if (! $this->_tpl_vars['sm']['res1'][$this->_tpl_vars['x']['id_team']]): ?>
                                        <a href="javascript:void(0);" onclick="remove_team('<?php echo $this->_tpl_vars['x']['id_team']; ?>
','')"><img src="http://localhost/simplehrm/templates/images/blue/delete_img.png" alt="" title="Delete"/></a>		
                                    <?php endif; ?>
                                </td>
                                </tr>
                            <?php endfor; endif; ?>
