<?php /* Smarty version 2.6.7, created on 2017-08-24 10:48:57
         compiled from report/employeeSalList.tpl.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'report/employeeSalList.tpl.html', 64, false),array('modifier', 'capitalize', 'report/employeeSalList.tpl.html', 74, false),array('modifier', 'default', 'report/employeeSalList.tpl.html', 74, false),)), $this); ?>

<!-- Template: report/employeeSalList.tpl.html Start 24/08/2017 10:48:57 --> 
 <?php $this->assign('emp_sts', $this->_tpl_vars['util']->get_values_from_config('EMPLOYMENT_STATUS'));  $this->assign('m', $this->_tpl_vars['sm']['next_prev']->module);  if (defined ( @LINK_SEPARATOR )): ?>
    ...
    <div class="cont_bg_mdl">
    	<div class="cont_hdr1 fltlft">
            ...
            <div class="cont_hdr_mdl1 fltlft">Employee salary list (<?php echo $this->_tpl_vars['sm']['next_prev']->total; ?>
)
                <div class="fltrht">
                </div>
                <div class="clear"></div>
...
?>
 ...
 email <?php if (($this->_foreach['foric']['iteration'] == $this->_foreach['foric']['total'])): ?>brdr_none<?php endif; ?>" title="Click on <?php echo $this->_tpl_vars['item']['0']; ?>
 to sort">
...
"><b><?php echo $this->_tpl_vars['x']['name']; ?>
                                ...
                                <td>
                                    <?php if ($this->_tpl_vars['sm']['res_terminate'][$this->_tpl_vars['x']['id_employee']]): ?>
                                        <a onclick="showTerminateReason('<?php echo $this->_tpl_vars['x']['id_employee']; ?>
...
<!-- Template: report/employeeSalList.tpl.html End --> 