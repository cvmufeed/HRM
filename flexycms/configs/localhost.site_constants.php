<?php
define("APP_ROOT",$_SERVER['DOCUMENT_ROOT']."/".ARR_SUBDIR."/".SUB_DIR); // Document root of application
...
define("SITE_DOMAIN_NAME", $_SERVER['HTTP_HOST']."/".ARR_SUBDIR."/".SUB_DIR);
...
define("JS_PATH",'http://'.$_SERVER['HTTP_HOST']."/".ARR_SUBDIR."/");

if($_SERVER['SERVER_ADDR']=='192.168.1.222'){
	define("JS_PATH_EXT",'http://'.$_SERVER['HTTP_HOST']."/".ARR_SUBDIR."/libsext/");
}else{
